         ...
         <div class="container py-lg-5 py-md-5 py-sm-4 py-4">
            ...
            <div class="row banner-below-w3l">
               <div class="col-lg-4 col-md-6 col-sm-6 text-center banner-agile-flowers">
                  <img src="C:\Users\Tuhis\OneDrive\Desktop\AGM\Art-Gallery-MS-PHP\agms\sculpt.png" width="200" height="200" class="img-thumbnail" alt="">
                  <div class="banner-right-icon">
                     <h4 class="pt-3">Sculptures</h4>
                  </div>
               </div>
               <div class="col-lg-4 col-md-6 col-sm-6 text-center banner-agile-flowers">
                  <img src="C:\Users\Tuhis\OneDrive\Desktop\AGM\Art-Gallery-MS-PHP\agms\seri.png" width="200" height="200" class="img-thumbnail" alt="">
                  <div class="banner-right-icon">
                     <h4 class="pt-3">Serigraphs</h4>
                  </div>
               </div>
               <div class="col-lg-4 col-md-6 col-sm-6 text-center banner-agile-flowers">
                  <img src="C:\Users\Tuhis\OneDrive\Desktop\AGM\Art-Gallery-MS-PHP\agms\pri.png" width="200" height="200" class="img-thumbnail" alt="">
                  <div class="banner-right-icon">
                     <h4 class="pt-3">Prints</h4>
                  </div>
               </div>
               <div class="col-lg-4 col-md-6 col-sm-6 mt-3 text-center banner-agile-flowers">
                  <img src="C:\Users\Tuhis\OneDrive\Desktop\AGM\Art-Gallery-MS-PHP\agms\pain.png" width="200" height="200" class="img-thumbnail" alt="">
                  <div class="banner-right-icon">
                     <h4 class="pt-3">Painting</h4>
                  </div>
               </div>
               <div class="col-lg-4 col-md-6 col-sm-6 mt-3 text-center banner-agile-flowers">
                  <img src="C:\Users\Tuhis\OneDrive\Desktop\AGM\Art-Gallery-MS-PHP\agms\street.png" width="200" height="200" class="img-thumbnail" alt="">
                  <div class="banner-right-icon">
                     <h4 class="pt-3">Street Art</h4>
                  </div>
               </div>
               <div class="col-lg-4 col-md-6 col-sm-6 mt-3 text-center banner-agile-flowers">
                  <img src="C:\Users\Tuhis\OneDrive\Desktop\AGM\Art-Gallery-MS-PHP\agms\visual.png" width="500" height="200" class="img-thumbnail" alt="">
                  <div class="banner-right-icon">
